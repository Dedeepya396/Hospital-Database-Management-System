...
#### If we choose 3:
- It prints number of Doctors in every Department.
...
#### If we choose 10:
- It prints the number of surgeries performed by each doctor.

#### If we choose 11:
- It prints number of patients handled by each doctor.
